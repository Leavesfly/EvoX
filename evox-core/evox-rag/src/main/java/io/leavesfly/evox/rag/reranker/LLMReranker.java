...
public class LLMReranker implements Reranker {
    ...
    public LLMReranker(BaseLLM llm, String promptTemplate, double scoreThreshold) {
        this.llm = llm;
    ...
    public LLMReranker(BaseLLM llm) {
        this(llm, null, 0.0);
    }

    public LLMReranker(BaseLLM llm, double scoreThreshold) {
