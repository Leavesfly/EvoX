...
public class GitTool extends BaseTool {
    ...
    public GitTool(String workingDirectory) {
        ...
        operationParam.put("description", "Git operation: status, diff, log, add, commit, branch, checkout, show, blame");
    ...
    public ToolResult execute(Map<String, Object> parameters) {
        ...
        return switch (operation) {
            ...
            default -> ToolResult.failure("Unknown git operation: " + operation
                    + ". Supported: status, diff, log, add, commit, branch, checkout, show, blame");
        };
    }
